...
object AnalyzeBookRequest {
   ...
   * @return
   */
  def analyzeBookRequest(requestTypeLabel: RequestType, requestMethod: String, contentType: String, request: String,
                         requestBody: String, travelType: TravelTypeEnum, analyzeRules: List[AnalyzeRule]): Option[BookRequestData] = {
